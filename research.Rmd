...
Fragmentation and assembly of production across the globe, popularly referred to as offshoring, is typically associated with lost jobs and displaced workers. However, often ignored is a dimension of productivity-enhancing, within-firm reorganization spurred by offshoring. This paper provides novel evidence that such reorganization can take place in the form of increased innovation and change in firm level employment composition in favor of high-skilled workers. I use firm-level microdata from the manufacturing sector in Spain to construct a plausibly exogenous measure of offshoring. I show that, following the financial crisis of 2008, offshoring has a positive effect on R&D expenditures and high-skilled employment. Accounting for heterogenous responses, I find firm size, age, innovation history and availability of credit to be important determinants of the effect of offshoring on R&D investments. Finally, I build a structural model to highlight the precise channels of gains from trade and find that Spanish firms benefit from a higher variety of foreign intermediates across different manufacturing sectors.
